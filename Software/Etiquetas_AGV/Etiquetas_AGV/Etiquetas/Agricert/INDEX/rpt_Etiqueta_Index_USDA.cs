...
{
    public partial class rpt_Etiqueta_Index_USDA : DevExpress.XtraReports.UI.XtraReport
    {
        public rpt_Etiqueta_Index_USDA(string c_codigo_tem, string c_codigo_pal, string c_codsec_pal, string c_codigo_dis, string c_codigo_sec, string voice1, string voice2,string c_codigo_jul,Boolean plu)
        {
