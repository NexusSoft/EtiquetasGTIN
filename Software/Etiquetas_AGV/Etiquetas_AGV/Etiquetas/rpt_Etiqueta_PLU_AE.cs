...
namespace Etiquetas_AGV
{
    ...
    {
        public rpt_Etiqueta_PLU_AE(string c_codigo_tem, string c_codigo_pal, string c_codsec_pal, string c_codigo_dis, string c_codigo_sec, string voice1, string voice2)
        {
