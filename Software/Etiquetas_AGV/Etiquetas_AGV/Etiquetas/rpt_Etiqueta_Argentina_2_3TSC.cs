...
{
    public partial class rpt_Etiqueta_Argentina_2_3TSC : DevExpress.XtraReports.UI.XtraReport
    {
        public string c_codigo_jul { get; set; }
        public rpt_Etiqueta_Argentina_2_3TSC(string c_codigo_tem, string c_codigo_pal, string c_codsec_pal, string c_codigo_dis, string c_codigo_sec, string voice1, string voice2)
        {
